...
\item Числительные меньше либо равные десяти пишем словами.
Вася купил втридорога 5 яблок — плохо. 
Вася сорвал с дерева нахаляву семь яблок — хорошо.
\item Обрати внимание, как называются файлы предыдущих конспектов. Сделай вывод :)
\end{enumerate}
