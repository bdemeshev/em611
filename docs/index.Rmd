...
Дз: посчитать все возможные ожидания, ковариации для y, \hat y, \hat b, u, \hat u, \bar y.
...
* Неделя 4. (план) Геометрический смысл t, F-распределений. Проверка гипотез в линейной модели. 
