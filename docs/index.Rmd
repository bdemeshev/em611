...
* [Шаблон](https://github.com/bdemeshev/em611/blob/master/2017/note_template/note_template.tex) для конспектирования лекций, [картинки для МНК](https://github.com/olyagnilova/gauss-markov-pythagoras) из работы Оли Гниловой, их можно свободно использовать.
...
* Встреча 2. Обсуждение домашки, SVD, постановка задачи PCA.
    ...
    - Конспект Марины (бета-версия): [pdf](https://github.com/bdemeshev/em611/raw/master/2018/notes/seminar_02.pdf), [tex](https://github.com/bdemeshev/em611/raw/master/2018/notes/seminar_02.tex) 
...
* Встреча 3. Эквивалентность PCA и SVD.
    ...
    - Конспект Лизы (бета-версия): [pdf](https://github.com/bdemeshev/em611/raw/master/2018/notes/seminar_03.pdf), [tex](https://github.com/bdemeshev/em611/raw/master/2018/notes/seminar_03.tex)
...
* Встреча 4. Работа с ковариационными матрицами, геометрическое доказательство теоремы Гаусса-Маркова, проверка гипотез о коэффициенте и сравнение двух моделей
    ...
    - Конспект Ефим Лубошников (бета-версия): [pdf](https://github.com/bdemeshev/em611/raw/master/2018/notes/seminar_04.pdf), [tex](https://github.com/bdemeshev/em611/raw/master/2018/notes/seminar_04.tex)
